...
# Crop primitives live in core.crop (Open3D-free, headless-testable);
# re-exported here so existing importers keep working.
from core.crop import (  # noqa: F401
    clip_segment_to_circle, segments_in_crop, point_in_crop,
...
# ─────────────────────────────────────────────────────────────────────────────
# SPATIAL CLIPPING / FILTERING — moved to core/crop.py (re-exported above)
# ─────────────────────────────────────────────────────────────────────────────
